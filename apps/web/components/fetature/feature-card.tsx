...
export default function FeatureCard({ cardData }: FeatureCardProps) {
  ...
  return (
    <Card className="transition-transform hover:scale-105 hover:shadow-md hover:border-primary/80 duration-300 group dark:bg-background/80 cursor-pointer border border-dashed">
